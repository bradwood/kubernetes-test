...
# Removed references to VMWare -- see the above url to hack in VMWare support
...
#files needed byy the CoreOS Bootstrap. Make sure to include in the same dir as
#this file.
CLOUD_CONFIG_PATH = File.join(File.dirname(__FILE__), "user-data")
CONFIG = File.join(File.dirname(__FILE__), "config.rb")

# Defaults for CoreOS config options defined in CONFIG
$num_instances = 1
